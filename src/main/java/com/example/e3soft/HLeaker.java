...
public class HLeaker extends Activity {

    public static String refinery, uni;
    private String curResT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hleaker);
        ...
        siteSp.setOnItemSelectedListener(new
    ...
    protected void loadLeakList() {
        ...
        try {
            List<String> pUnit = db.viewLeaks();
    ...
    protected void loadUnitSpinner() {
        ...
        // Spinner Drop down elements
        try {
            List<String> pUnit = db.viewUnit2();
    ...
    protected void duplicatePrompt() {
        new AlertDialog.Builder(this)
                .setMessage("Leak result already exists")
                .setCancelable(false)
        ...
        new AlertDialog.Builder(this)
                ...
                .setNeutralButton("HOME",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                Intent i = new Intent(HLeaker.this, Home.class);
                                startActivity(i);
                                finish();
                            }
