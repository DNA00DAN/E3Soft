...
public class LocalOldLeaks extends Activity {

    private Spinner siteSp,oldSp;
    ...
    private Cursor c10;
    private String currentDate, strCf,refinery;
    private String leakerT = "LM_4000001", reading = "PPM", prevResT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_old_leaks);
    ...
    private void populateOldLeaks() {
        ...
        if (refinery.equals("Filling Station")) {
            populateSpinnerDropDownWith(db.viewStations());
        } else if (refinery.equals("Depot")) {
            populateSpinnerDropDownWith(db.viewDepots());
        }

    }

    private void populateSpinnerDropDownWith(List<String> pUnit) {
        try {
    ...
    protected void saveFile() throws IOException {
        if (siteSp.getSelectedItem().toString().equals("Filling Station")) {
            ...
            String fileName = "oldFillingLeaksData.csv";
            ...
            String direc = "/e3softData/";
            String fileName = "oldDepotLeaksData.csv";
            // get the path to sdcard
            File sdcard = Environment.getExternalStorageDirectory();
            // to this path add a new directory path
            File dir = new File(sdcard.getAbsolutePath() + direc);
    ...
    protected void updateRes() {
        DataClass db = new DataClass(getApplicationContext());
        if (siteSp.getSelectedItem().toString().equals("Filling Station")) {
            db.updateFSRes(leakerT, LocalUserDetails.cycleRes,
                    correctedReading);
        } else if (siteSp.getSelectedItem().toString().equals("Depot")) {
            db.updateDepotRes(leakerT, LocalUserDetails.cycleRes,
                    correctedReading);
        }
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setNeutralButton("HOME",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                Intent i = new Intent(LocalOldLeaks.this, Home.class);
                                startActivity(i);
                                finish();
                            }
    ...
    private void initialiseComponents() {
        ...
        oldSp = (Spinner) findViewById(R.id.oldLeaksLMSp);
