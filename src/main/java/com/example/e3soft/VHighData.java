...
public class VHighData extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "vHighLeaker.db";

    private static final String tblHighLeaker = "vHighLeaker";
    ...
    public VHighData(Context context) {
    ...
    public void insertHighLeaker(int id, String busi, String name,
                                 String drawing,
                                 String leakerID,
    ...
    public void updateHighLeaker(String leakerT, String strMRes,
        ...
        dbr2.execSQL("UPDATE vHighLeaker SET " + "newC1Result" + " = '" + strMRes + "', "
                + "loss" + " = '" + strMResult + "', "
    ...
    public void updateHighLeaker2(String leakerT, String strMRes,
        ...
        SQLiteDatabase dbr2 = this.getWritableDatabase();
        dbr2.execSQL("UPDATE vHighLeaker SET " + Cyc + " = '" + strMRes + "', "
                + "loss" + " = '" + strMResult + "', "
                + "readingUnit" + " = '" + readingT + "', "
                + "recommendation" + " = '" + strRecommendation + "' "
                + " WHERE leakerID='" + leakerT + "'");
