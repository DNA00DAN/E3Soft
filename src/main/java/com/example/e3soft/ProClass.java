...
public class ProClass extends SQLiteOpenHelper {
    // Database Version
    ...
    // Labels table name
    private static final String tblPROS = "nwPros";
    ...
    public ProClass(Context context) {
    ...
    public List<String> getAllPros(String are) {
        List<String> dDay = new ArrayList<String>();

        // Select All Query
        String selectQuery = "SELECT  * FROM " + tblPROS +
    ...
    public void insertProduct(String streamT, String productTT, String cfTT) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_STREAM, streamT);
        values.put(KEY_PRODUCT, productTT);
        values.put(KEY_CF, cfTT);

        db.insert("nwPros", null, values);
