...
public class Dreport extends Activity {

    private TextView date, leaker, camOp, camSerial, gasOp, gasSerial, type,
            location, drawing, recom, product,
            equipmentDesc, equipmentType, mResult, aLoss, reading,
            equipmentSize, equipmentClass, equipmentId, mPosition, dateCreate,
            subD, cyc;
    ...
    protected void loadImage() {
        try {
            ...
            if (path.exists()) {
                ...
                Drawable image = Drawable.createFromPath("/sdcard/e3softData/DCIM" + "/" + leakerT + ".jpg");
                Log.d("image path", fileNames);
                Bitmap mBitmap = BitmapFactory.decodeFile(fileNames);
                img.setImageBitmap(Bitmap.createScaledBitmap(mBitmap, 250, 250, false));
            }
        } catch (Exception e) {
            File path = new File("/sdcard/e3softData/Data");
            String fileNames = path + "/" + "000.png";
            Drawable image = Drawable
                    .createFromPath("/sdcard/e3softData/Data" + "/"
                            + "000.png");
            Log.d("image path", fileNames);
            Bitmap mBitmap = BitmapFactory.decodeFile(fileNames);
    ...
    protected void saveCSV() throws IOException {
        ...
        String fileName = "newDepotLeaksData.csv";
    ...
    private void populateTextFields() {
        ...
        Cursor c10 = db10.rawQuery("SELECT *" + " FROM dHighLeaker reports "
                + "WHERE reports.leakerID = '" + leakerT + "' ORDER BY leakerID ASC", null);
        ...
        int pro9 = c10.getColumnIndex("location");
    ...
    private void InitialiseComponents() {
        saveBtn = (Button) findViewById(R.id.dSendBtn);
        searchB = (Button) findViewById(R.id.desearchRe);
        reportsSpin = (Spinner) findViewById(R.id.dereportNr);
        date = (TextView) findViewById(R.id.dDate);
        leaker = (TextView) findViewById(R.id.dLeaker);
        camOp = (TextView) findViewById(R.id.dCamOperator);
        camSerial = (TextView) findViewById(R.id.dCamSerial);
        gasOp = (TextView) findViewById(R.id.dGasOperator);
        gasSerial = (TextView) findViewById(R.id.dGasSerial);
        type = (TextView) findViewById(R.id.dType);
        location = (TextView) findViewById(R.id.dLocation);
        drawing = (TextView) findViewById(R.id.dDrawing);

        product = (TextView) findViewById(R.id.dproduct);
        equipmentDesc = (TextView) findViewById(R.id.dequipDesc);
        subD = (TextView) findViewById(R.id.dsubDesc);
        equipmentType = (TextView) findViewById(R.id.dequipType);
        reading = (TextView) findViewById(R.id.dreading);
        equipmentSize = (TextView) findViewById(R.id.dequipSize);
        equipmentClass = (TextView) findViewById(R.id.dequipClass);
        equipmentId = (TextView) findViewById(R.id.dequipID);
        mPosition = (TextView) findViewById(R.id.dmPosition);
        img = (ImageView) findViewById(R.id.dimageTaken);
        mResult = (TextView) findViewById(R.id.dmResult);
        aLoss = (TextView) findViewById(R.id.dloss);
        recom = (TextView) findViewById(R.id.drecom);
        cyc = (TextView) findViewById(R.id.dcyc);

        layout = (LinearLayout) findViewById(R.id.delayout1);
        tR = (TableRow) findViewById(R.id.dereportSpTb);
    }
