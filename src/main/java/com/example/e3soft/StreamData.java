...
public class StreamData extends SQLiteOpenHelper {
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "newStreams.db";
    // Labels table name
    private static final String tblSTREAM = "nwStreams";
