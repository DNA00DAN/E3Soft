...
public class DepotData extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "depotReports.db";
    // Labels table name
    private static final String tblReports = "depotReports";
    ...
    public DepotData(Context context) {
